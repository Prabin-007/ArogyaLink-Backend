 ...
 * inside a controller. Honors the AUTH_ENABLED=false dev bypass so the fake
 * dev-admin user (role: SYSTEM_ADMIN) isn't 403'd by hand-rolled checks that
 * the route-level `authorize()` middleware already let through.
 */
